...
"""
crystal-cell-settler - A GUI tool to set and adjust unit cell parameters for molecular structures.

Author: Hiromichi Yokoyama
License: Apache-2.0 license
Repo: https://github.com/HiroYokoyama/crystal-cell-settler
"""
...
class CellSetterApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Python Cell Setter ver. 0.1.0")
        ...
        control_layout.addWidget(cell_label)
        ...
        control_layout.addWidget(cell_group)
        ...
        control_layout.addWidget(self.apply_cell_button)
        ...
        control_layout.addWidget(struct_label)
        ...
        control_layout.addWidget(self.fit_to_cell_button)
        ...
        control_layout.addWidget(self.fix_atom0_button)
        ...
        control_layout.addWidget(self.optimize_coord_button)
        
        control_layout.addSpacing(20)
        
        # === Transform Controls ===
        transform_label = QLabel("=== Transform Controls ===")
        control_layout.addWidget(transform_label)
        ...
        control_layout.addWidget(translate_group)
        ...
        control_layout.addWidget(self.toggle_indices_button)
    ...
    def draw_scene_manually(self, force_reset=False, cell_center=(0.0, 0.0, 0.0)):
        if self.atoms is None:
            return
        ...
        # --- 2.5. 原子インデックスをラベル表示 ---
        if self.show_atom_indices and len(positions) > 0:
